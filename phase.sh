...
SAMPLE=$1
SCAFFOLDS=`cut -d$'\t' -f1 ragoo/ragoo.fasta.fai`
export HIC
export VCF
export SAMPLE
...
\time -v parallel 'extractHAIRS --bam $HIC/hic.ragoo.{}.bam --hic 1 --VCF $VCF/pacbioccs.ragoo.{}.filtered.vcf --out hapcut2/hic.{}.frag --maxIS 30000000 2> hapcut2/extractHAIRS.{}.log' ::: $SCAFFOLDS 2> extractHAIRS.log
...
\time -v parallel 'whatshap phase --reference ragoo/ragoo.fasta $VCF/pacbioccs.ragoo.{}.filtered.vcf hapcut2/hic.{}.phased.vcf alignment/pacbioccs/split/pacbioccs.ragoo.{}.bam -o whatshap/pacbioccs.hic.{}.whatshap.phased.vcf 2> whatshap/whatshap.{}.log' ::: $SCAFFOLDS  2> whatshap.phase.log
