...
parser.add_argument('--scaffolds', metavar = 'FASTA', type = str, required = True, 
                     help = 'The input reference scaffolds')
parser.add_argument('--ragoo', action = 'store_true', 
...
if args.female:
    ...
    female = 'FALSE'
commands = [args.hic_path, args.pb_path, args.scaffolds, ragoo, ref, args.sample, female, args.prefix]
