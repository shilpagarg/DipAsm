...
minimap2 --paf-no-hit -cxasm5 --cs -r2k -t36 ref/${CHR}.fasta dipasm/${CHR}_RaGOO-p_ctg_cns-H1.fa | sort -k6,6 -k8,8n | ~/tools/paftools.js call -f ref/${CHR}.fasta - | grep -E "^#|^$CHR$t" | htsbox bgzip > $OUTDIR/${CHR}.H1.vcf.gz
minimap2 --paf-no-hit -cxasm5 --cs -r2k -t36 ref/${CHR}.fasta dipasm/${CHR}_RaGOO-p_ctg_cns-H2.fa | sort -k6,6 -k8,8n | ~/tools/paftools.js call -f ref/${CHR}.fasta - | grep -E "^#|^$CHR$t" | htsbox bgzip > $OUTDIR/${CHR}.H2.vcf.gz
