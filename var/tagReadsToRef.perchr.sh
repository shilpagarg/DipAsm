...
~/tools/truvari/truvari/truvari -f $OUT/ref/${REF##*/} -b $SV --includebed $BED -o $OUT/sniffles_vcf/truvari_${CHR} --giabreport --passonly -r 1000 -p 0.00 -c $OUT/sniffles_vcf/${PREFIX}.sniffles.phased.vcf.gz
